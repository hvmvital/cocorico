...
use Cocorico\CoreBundle\Model\BaseListingFile;
 ...
 * @ORM\Entity
 *
 * @ORM\Table(name="listing_file", indexes={
 *    @ORM\Index(name="position_li_idx", columns={"position"})
 *  })
 *
 */
class ListingFile extends BaseListingFile
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Listing", inversedBy="files")
